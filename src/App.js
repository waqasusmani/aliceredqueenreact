  ...
  */
  ...
  setInterval(function () {
    ...
    if (redQueen_alice.playbackRate<=1) {
      document.getElementById("greenPotionWarning").style.visibility="visible"
    }
    else {
      document.getElementById("greenPotionWarning").style.visibility="hidden"
    }
  }, 3000);
  ...
  return (
    <div className="wrapper">
      <h3 id="greenPotionWarning">Alice needs green potion to run faster.<br></br>Click to give her the potion.</h3>
      <img id="potion" src={require('./potion.png')} alt="potionforalice"></img>
